// src/components/layout/Sidebar/NavItems.tsx 
  ...
  // RM Section
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: (
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <path d="M7 2h8l4 4v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z" strokeWidth="1.5" />
            <path d="M9 11h6M9 15h6" strokeWidth="1.5" />
          </svg>
        ),
      },
      {
